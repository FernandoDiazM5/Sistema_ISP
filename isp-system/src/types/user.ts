...
export const DEFAULT_PERMISSIONS = {
    [ROLES.SUPER_ADMIN]: {
        ...
        [MODULES.MANTENIMIENTO]: PERMISSION_LEVELS.ADMIN,
    },
    [ROLES.ADMIN]: {
        [MODULES.DASHBOARD]: PERMISSION_LEVELS.ADMIN,
        [MODULES.CLIENTES]: PERMISSION_LEVELS.ADMIN,
        ...
        [MODULES.MANTENIMIENTO]: PERMISSION_LEVELS.WRITE,
    },
    [ROLES.TECNICO]: {
        ...
        [MODULES.USUARIOS]: PERMISSION_LEVELS.NONE,
        [MODULES.MANTENIMIENTO]: PERMISSION_LEVELS.NONE,
    },
    [ROLES.VIEWER]: {
        [MODULES.DASHBOARD]: PERMISSION_LEVELS.READ,
...
export const MODULE_LABELS = {
    ...
    [MODULES.MANTENIMIENTO]: 'Mantenimiento',
} as const;
