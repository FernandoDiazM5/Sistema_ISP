...
function getDataSnapshot() {
    ...
    return {
        ...
        subcategorias: s.subcategorias,
        prioridadesSLA: s.prioridadesSLA,
        estadosCatalogo: s.estadosCatalogo,
        catalogoServicios: s.catalogoServicios,
        tiposRequerimiento: s.tiposRequerimiento,
        averiasTipos: s.averiasTipos,
        tiposVisita: s.tiposVisita,
        tiposSesionSoporte: s.tiposSesionSoporte,
        tiposDerivacion: s.tiposDerivacion,
        tiposEquipo: s.tiposEquipo,
        marcasEquipo: s.marcasEquipo,
        planesInstalacion: s.planesInstalacion,
        tecnologiasInstalacion: s.tecnologiasInstalacion,
