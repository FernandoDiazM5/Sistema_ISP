import{c as d,r as m,j as n}from"./index-z5gwiLCk.js";const l=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],b=d("check",l);const u=[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]],C=d("copy",u);function E(o,e){return`📌 INSTALACIÓN ${(o.tecnologia||e?.tecnologia||"FIBRA OPTICA").toUpperCase()}
