import{c as s,r as m,j as n}from"./index-DBbpf6L9.js";import{C as l}from"./check-DDCzPa57.js";const b=[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]],C=s("copy",b);function E(o,e){return`📌 INSTALACIÓN ${(o.tecnologia||e?.tecnologia||"FIBRA OPTICA").toUpperCase()}
...
────────────────────────
📝 *Nota:* ${o.observaciones||o.nota||""}`}async function u(o){try{return await navigator.clipboard.writeText(o),!0}catch{const e=document.createElement("textarea");e.value=o,e.style.position="fixed",e.style.opacity="0",document.body.appendChild(e),e.select();try{return document.execCommand("copy"),document.body.removeChild(e),!0}catch{return document.body.removeChild(e),!1}}}function x({getTextFn:o,title:e="Copiar para WhatsApp",size:c="sm"}){const[r,t]=m.useState(!1),d=async i=>{i.stopPropagation();const $=o();await u($)&&(t(!0),setTimeout(()=>t(!1),2e3))},a=c==="sm"?13:16;return n.jsx("button",{onClick:d,title:r?"¡Copiado!":e,className:`inline-flex items-center justify-center rounded-lg border transition-all cursor-pointer ${r?"bg-green-500/20 border-green-500/30 text-green-400":"bg-bg-secondary border-border text-text-muted hover:text-accent-blue hover:border-accent-blue/50 hover:bg-accent-blue/10"} ${c==="sm"?"w-7 h-7":"w-8 h-8"}`,children:r?n.jsx(l,{size:a}):n.jsx(C,{size:a})})}export{x as C,T as a,y as b,A as c,C as d,I as e,g as f,E as g,N as h};
